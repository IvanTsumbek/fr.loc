...
class Pagination
{
    ...
    public function __construct(
        ...
        protected int $perPage = PAGINATION_SETTINGS['per_page'],
        protected int $midSize = PAGINATION_SETTINGS['mid_size'],
        protected int $maxPages = PAGINATION_SETTINGS['max_pages'],
